    ...
    @can('destination_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', ['model' => 'Destination', 'route' => 'admin.destinations.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="row">
                    ...
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Destination">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    {{ trans('cruds.destination.fields.nom') }}
                                </th>
                                <th>
                                    {{ trans('cruds.destination.fields.budget_global') }}
                                </th>
                                <th>
                                    {{ trans('cruds.destination.fields.solde') }}
                                </th>
                                <th>
                                    &nbsp;
                                </th>
...
{ data: 'id', name: 'id' },
{ data: 'nom', name: 'nom' },
{ data: 'budget_global', name: 'budget_global' },
