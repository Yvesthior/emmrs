                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.destinations.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('budget_global') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="budget_global" id="budget_global" value="{{ old('budget_global', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('solde') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="solde" id="solde" value="{{ old('solde', '') }}" step="1" required>
                            @if($errors->has('solde'))
