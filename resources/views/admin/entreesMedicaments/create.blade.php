        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.entreesMedicament.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.entrees-medicaments.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('conditonnement') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="conditonnement_id" id="conditonnement_id">
                                @foreach($conditonnements as $id => $entry)
                                    <option value="{{ $id }}" {{ old('conditonnement_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('nombre_conditionnement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="nombre_conditionnement" id="nombre_conditionnement" value="{{ old('nombre_conditionnement', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('upc') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="upc" id="upc" value="{{ old('upc', '1') }}">
                            @if($errors->has('upc'))
