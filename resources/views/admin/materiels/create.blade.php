        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.materiel.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.materiels.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('lot') ? 'has-error' : '' }}">
                            <label for="lot">{{ trans('cruds.materiel.fields.lot') }}</label>
                            <input class="form-control" type="text" name="lot" id="lot" value="{{ old('lot', '') }}">
                            @if($errors->has('lot'))
                        ...
                        <div class="form-group {{ $errors->has('date_inventaire') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_inventaire" id="date_inventaire" value="{{ old('date_inventaire') }}">
                        ...
                        <div class="form-group {{ $errors->has('quantite') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="quantite" id="quantite" value="{{ old('quantite', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('marque') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="marque" id="marque" value="{{ old('marque', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('modele') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="modele" id="modele" value="{{ old('modele', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('numero_serie') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="numero_serie" id="numero_serie" value="{{ old('numero_serie', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('representant_local') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="representant_local_id" id="representant_local_id">
                                @foreach($representant_locals as $id => $entry)
                                    <option value="{{ $id }}" {{ old('representant_local_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('prix_unitaire') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="prix_unitaire" id="prix_unitaire" value="{{ old('prix_unitaire', '') }}" step="1">
