        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.representantsLocaux.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.representants-locauxes.store") }}" enctype="multipart/form-data">
                        @csrf
